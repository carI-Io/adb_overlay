...
out_4326 = Path(r"/home/admin_climatecharted_com/data/Altezza") / "adbpo_pgra2027_l_merged_4326_2m.tif"

gdal.BuildVRT(str(vrt_path), [str(f) for f in tif_files])
logging.info(f"VRT built at {vrt_path}")

out_3035 = Path(r"/home/admin_climatecharted_com/data/Altezza") / "adbpo_pgra2027_l_merged_3035_2m.tif"
gdal.Translate(
    str(out_3035),
    str(vrt_path),
    creationOptions=[

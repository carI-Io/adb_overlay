...
# -------------------------
gdf_H_dissolved = dissolve_touching_by_rp(gdfs["H"])
gdf_M_dissolved = dissolve_touching_by_rp(gdfs["M"])
gdf_L_dissolved = dissolve_touching_by_rp(gdfs["L"])
...
final_gdf.to_file(r"/home/admin_climatecharted_com/data/ADB/AA_pda2025_H_M_L")
